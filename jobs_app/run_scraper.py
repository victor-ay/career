...
subprocess.run(['DJANGO_SETTINGS_MODULE=career_proj.prod_settings python3','/home/ubuntu/src/career/jobs_scrappers/linkedin_scrapper/get_linkedin_jobs_to_db.py'])